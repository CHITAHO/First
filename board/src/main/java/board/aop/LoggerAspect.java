 ...
 * if(name.indexOf("Controller") > -1) { type = "Controller  \t:  "; } else
 * if(name.indexOf("Service") > -1) { type = "ServiceImpl  \t:  "; } else
 * if(name.indexOf("Mapper") > -1) { type = "Mapper  \t\t:  "; } log.debug(type
 * + name + "." + joinPoint.getSignature().getName() + "()"); return
 * joinPoint.proceed(); } }
 */